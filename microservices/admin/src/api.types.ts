...
export type MutationTodosInsertArgs = {
  input: TodosInsertInput;
};


export type MutationTodosRemoveArgs = {
  input: TodosRemoveInput;
};


export type MutationTodosUpdateArgs = {
...
export type UserInsertInput = {
  ...
  roles: Array<Maybe<UserRole>>;
  todos: Array<Maybe<UserTodoInput>>;
};
...
export type UserUpdateInput = {
  ...
  todos?: Maybe<Array<Maybe<UserTodoInput>>>;
};
